...
<div class="text-center p-4">
  <img width="300px" src="../img/rover2.png" class="img-thumbnail" >
  <img width="400px" src="../img/rover1.jpg" class="img-thumbnail" >
  <img width="300px" src="../img/rover3.png" class="img-thumbnail" >
</div>
