...
<div class="text-center p-4">
  <img width="250px" src="../img/rover2.png" class="img-thumbnail" >
  <img width="416px" src="../img/rover1.jpg" class="img-thumbnail" >
  <img width="260px" src="../img/rover3.png" class="img-thumbnail" >
</div>
